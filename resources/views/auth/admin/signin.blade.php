...
<section>
    <div class="container">
     <ol class="breadcrumb">
       ...
       <li class="active" style="font-weight: bold;color:black;">Admin SignIn</li>
     </ol>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6" style="background-color:black;">
           <h2 class="text-center" style="color:#05A9E8;font-weight: bold;">ADMIN SIGNIN</h2> 
        </div>
    ...
    <div class="container">
        <div class="row">
          <div class="col-md-3"></div>
          <div class="col-md-6">
            <form class="form-vertical" role="form" method="post" action="{{route('auth.admin.signin')}}">
