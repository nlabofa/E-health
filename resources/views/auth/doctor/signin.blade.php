...
<section>
    <div class="container">
     <ol class="breadcrumb">
       ...
       <li class="active" style="font-weight: bold;color:black;">Doctor SignIn</li>
     </ol>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6" style="background-color:#05A9E8;">
           <h2 class="text-center" style="color:black;font-weight: bold;">DOCTOR SIGNIN</h2> 
        </div>
       ...
       <div class="row">
        ...
        <div class="col-md-4">
           <p class="text-center" style="background-color:#e1e1e1; "> <strong>I want to signin as a Patient!</strong></p> 
        </div>
    ...
    <div class="container">
        <div class="row">
          <div class="col-md-3"></div>
          <div class="col-md-6">
            <form class="form-vertical" role="form" method="post" action="{{route('auth.doctors.signin')}}">
                ...
                <div class="form-group">
                    <button type="submit" class="btn pull-right" style="background-color: #05A9E8;"><span style="color:white;font-weight: bold;">Sign In</span></button>
                </div>
